...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   Purple  #6D28D9 → ambition, creativity
   Pink    #DB2777 → social energy, connection
   Orange  #EA580C → confidence, action
   Teal    #0D9488 → clarity, focus
   Amber   #D97706 → warmth, celebration
   RULE: Zero border-radius. Solid fills. Margins expose gradient. No emojis in UI.
   ───────────────────────────────────────────────────────────────────────────── */
...
const STYLES = `
  ...
  /* ── Page shell ── */
  .dh-wrap  { display:flex; min-height:100vh; background:linear-gradient(160deg,#3730A3 0%,#6D28D9 28%,#BE185D 58%,#EA580C 82%,#D97706 100%); }
  ...
  /* ── Skeleton ── */
  .sk { background:linear-gradient(90deg,rgba(255,255,255,0.15) 25%,rgba(255,255,255,0.28) 50%,rgba(255,255,255,0.15) 75%); background-size:600px 100%; animation:shimmer 1.4s ease infinite; }
  .sk-card { background:rgba(255,255,255,0.10); padding:14px; margin:0 10px 6px; }
  .sk-compose { background:rgba(255,255,255,0.14); padding:14px; margin:0 10px 6px; }
  ...
  .compose-preview { margin-top:10px; display:flex; align-items:center; gap:10px; padding:8px 10px; background:#F5F3FF; border:1.5px solid #DDD6FE; }
  .compose-preview img { width:52px; height:52px; object-fit:cover; }
  ...
  /* ── Feed card — ZERO RADIUS, margin reveals gradient ── */
  .fc {
    background:#ffffff;
    margin:0 10px 6px;
    border-radius:0;
  ...
  .fc-act-btn { display:flex; align-items:center; gap:5px; background:none; border:none; cursor:pointer; padding:3px 6px; transition:background 0.12s; }
  ...
  .del-btn { font-size:11px; color:#a78bfa; background:none; border:none; cursor:pointer; padding:3px 8px; font-weight:700; }
  ...
  .fc-cover { width:100%; max-height:200px; object-fit:cover; display:block; margin-bottom:10px; cursor:zoom-in; }
  ...
  .fc-tag  { font-size:11px; padding:3px 8px; background:#EDE9FE; border:1.5px solid #DDD6FE; color:#6D28D9; font-family:monospace; font-weight:700; }
  ...
  /* ── Badges ── */
  .badge { font-size:10px; font-weight:800; padding:3px 9px; border-radius:0; font-family:'Nunito',sans-serif; flex-shrink:0; letter-spacing:0.04em; text-transform:uppercase; }
  ...
  /* ── Target card ── */
  .tc-tl-body { flex:1; background:#F9FAFB; border:1.5px solid #EDE9FE; padding:10px 12px; border-left:3px solid #7C3AED; margin-bottom:6px; }
  ...
  .tc-p-img  { max-width:110px; max-height:80px; object-fit:cover; border:1.5px solid #EDE9FE; display:block; margin-top:6px; cursor:zoom-in; }
  ...
  /* ── Comments ── */
  .cmt-wrap { margin-top:10px; background:#F9FAFB; border:1.5px solid #EDE9FE; overflow:hidden; }
  ...
  .cmt-bubble { background:#fff; padding:6px 10px; border:1.5px solid #EDE9FE; max-width:85%; }
  ...
  .cmt-form   { display:flex; align-items:center; gap:7px; padding:7px 10px; border-top:1.5px solid #EDE9FE; background:#fff; }
  .cmt-in {
    flex:1; background:#F5F3FF; border:1.5px solid transparent;
    outline:none; padding:7px 12px;
  ...
  .lightbox-img { max-width:94vw; max-height:92vh; object-fit:contain; box-shadow:0 12px 60px rgba(109,40,217,0.4); cursor:default; }
  .lightbox-close {
  ...
  .bday-wrap { margin:0 10px 6px; animation:bdaySlideIn 0.5s cubic-bezier(0.34,1.56,0.64,1); }
  .bday-banner {
...
// ── Birthday Banner (keeps emojis — shoutout system) ─────────────────────────
...
// ── Post Card ─────────────────────────────────────────────────────────────────
// NEW LAYOUT: profile photo + name at TOP, then image full-bleed, then caption, then actions
        ...
        {[0,1,2].map(i => (
          <div key={i} className="sk-card">
            <div style={{ display:"flex", gap:9, marginBottom:10, alignItems:"center" }}>
              <div className="sk" style={{ width:28, height:28, flexShrink:0 }} />
              <div className="sk" style={{ height:12, width:"28%", borderRadius:2 }} />
            </div>
            {i === 0 && <div className="sk" style={{ height:160, marginBottom:10 }} />}
            <div className="sk" style={{ height:10, width:"70%", borderRadius:2, marginBottom:5 }} />
            <div className="sk" style={{ height:10, width:"50%", borderRadius:2 }} />
          </div>
        ))}
      </div>
